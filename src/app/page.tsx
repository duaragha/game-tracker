...
import { isMarioKartGame, isPokemonGame, isACMirageGame } from '@/data';
...
const ACMirageTracker = dynamic(
  () => import('@/components/ACMirageTracker').then((mod) => mod.ACMirageTracker),
  {
    loading: () => (
      <div className="flex-1 flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-zinc-500" />
    ...
    <div className="flex h-screen bg-zinc-950 text-white">
      ...
      <main className={`flex-1 flex flex-col overflow-hidden ${sidebarOpen ? '' : 'ml-0'}`}>
        ...
        {isMK && currentGame ? (
          ...
          /* AC Mirage Tracker */
          <ACMirageTracker gameId={currentGame} />
        ) : (
          /* SMO Tracker */
