...
const smoTypeConfig: Record<CollectibleType, { label: string; icon: React.ReactNode; color: string }> = {
    ...
    <div className="bg-zinc-900 border-b border-zinc-800">
      ...
      <div className="px-4 py-2 border-t border-zinc-800">
          ...
          <div className="flex flex-wrap items-center gap-1.5 mt-2">
            ...
            {/* SMO Type Filters */}
            {!isMK && !isPKMN && (Object.entries(smoTypeConfig) as [CollectibleType, typeof smoTypeConfig[CollectibleType]][]).map(
              ([type, config]) => (
                <button
                  key={type}
